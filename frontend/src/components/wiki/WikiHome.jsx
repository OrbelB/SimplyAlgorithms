          ...
          <div className="wikibody">
            ...
            <div class="row gutters-sm">
                <div class="col-md-4 d-none d-md-block">
                    <div class="card">
                        <div class="card-body">
                        <nav class="nav flex-column nav-pills nav-gap-y-1 nav-size">
                            {/* Specific wiki topic pages will be implemented later, to be added in topics folder */}
                                ...
                                <br/>
                                <NavLink to="/wiki/sorting"  data-toggle="tab" className={"nav-item nav-link has-icon nav-link-faded fs"}>SORTING</NavLink>
