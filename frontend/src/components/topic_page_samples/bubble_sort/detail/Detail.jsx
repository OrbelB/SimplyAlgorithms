    ...
    <div className="detail text-center">
      <div className="top p-5">
        ...
        <div className="row justify-content-center text-center">
          <p className="size">
            Take an array of numbers &quot;5 1 4 2 8&quot;, and sort the array
            from lowest number to greatest number using bubble sort. In each
            step, elements written in <b>bold</b> are being compared. Three
        ...
        <div className="size steps_ text-start">
          <b>First Pass: </b> <br />
          <b>(1)</b> (<b> 5 1 </b> 4 2 8 ) → ( <b> 1 5 </b> 4 2 8 ), Here,
          algorithm compares the first two elements, and swaps since 5 &gt; 1.
          <br />
          <b>(2)</b> ( 1 <b>5 4</b> 2 8 ) → ( 1 <b>4 5 </b>2 8 ), Swap since 5
          <b>(3)</b> ( 1 4 <b>5 2 </b>8 ) → ( 1 4 <b>2 5</b> 8 ), Swap since 5
          &gt; 2 <br />
          <b>(4)</b> ( 1 4 2 <b>5 8</b> ) → ( 1 4 2 <b>5 8</b> ), Now, since
          these elements are already in order (8 &gt; 5), algorithm does not
          swap them. <br />
          <br />
          <b>Second pass</b>
          <br />
          <b>(1) </b>(<b> 1 4 </b> 2 5 8 ) → ( <b> 1 4 </b> 2 5 8 ) nothing
          swaped <br />
          <b>(2) </b>( 1 <b> 4 2 </b> 5 8 ) → ( 1 <b> 2 4 </b> 5 8 ), Swap since
          4 &gt; 2 <br />
          <b>(3) </b>( 1 2 <b> 4 5 </b> 8 ) → ( 1 2 <b> 4 5 </b> 8 ) nothing
          swaped
          <br />
          <b>(4) </b>( 1 2 4 <b> 5 8 </b> ) → ( 1 2 4 <b> 5 8 </b> ) nothing
          swaped
          <br />
          Now, the array is already sorted, but the algorithm does not know if
          it is completed. The algorithm needs one additional whole pass without
          any swap to know it is sorted.
          <br />
          <br />
          <b>Third Pass</b> <br />
          <b>(1) </b>( <b> 1 2 </b> 4 5 8 ) → ( <b> 1 2 </b> 4 5 8 ) Nothing
          swapped
          <br />
          <b>(2) </b>( 1 <b> 2 4 </b> 5 8 ) → ( 1 <b> 2 4 </b> 5 8 ) Nothing
          swapped
          <br />
          <b>(3) </b>( 1 2 <b> 4 5 </b> 8 ) → ( 1 2 <b> 4 5 </b> 8 ) Nothing
          swapped
      ...
      <div className="mid rounded-5 ">
        ...
        <p className="size text-center">
          One of the easiest algorithms to implement as a beginner and it works
          by repeatedly swapping the adjacent elements if they are in the wrong
          order. However, this algorithm should not be used for large data due
          to its bad time complexity. <br />
          <br />
          ...
          comparison sort, is named for the way the larger elements &quot;
      ...
      <div className="container-fluid bot">
        ...
        <div className="row justify-content-center text-center">
          <div className="size">
            Bubble sort is a brute force algorithm and should not really be used
            for applications that have large datasets that need to be sorted
            <br />-<br />
        ...
        <div className="row justify-content-around  mt-auto mt-sm-5   p-2">
          <div className="col-auto col-sm-auto align-self-center">
            ...
            <ul className="size">
              <li>
                <a
                  href="https://www.freecodecamp.org/news/bubble-sort-algorithm-in-java-cpp-python-with-example-code/"
                  target="_blank"
                  rel="noreferrer"
                >
          ...
          <div className="col-auto  text-center vid">
            <iframe
              ...
              width="auto"
              height="auto"
              src="https://www.youtube.com/embed/uJLwnsLn0_Q"
