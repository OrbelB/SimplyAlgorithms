    ...
    <div className="detail text-center">
      <div className="mid rounded-5 rounded-top">
        ...
        <p className="size font-weight-normal text-start">
          ...
          position of each element can be computed from its index tuple by a
          mathematical formula.The simplest type of data structure is a linear
          array, also called one-dimensional array.
          <br />
          <br />
          For simplicity, we can think of an array as a fleet of stairs where on
          each step is placed a value (let’s say one of your friends). Here, you
          can identify the location of any of your friends by simply knowing the
          ...
          to have the same size and should use the same data representation. The
          set of valid index tuples and the addresses of the elements (and hence
          the element addressing formula) are usually,[3][5] but not always,[2]
          fixed while the array is in use.
          <br />
          <br />
          The term &quot;array&quot; may also refer to an array data type, a
          kind of data type provided by most high-level programming languages
          ...
          may be implemented by hash tables, linked lists, search trees, or
        ...
        <p className="size text-start">
          It is a group of variables of similar data types referred to by a
          single element. Its elements are stored in a contiguous memory
          location. The size of the array should be mentioned while declaring
          it. Array elements are always counted from zero (0) onward. Array
          elements can be accessed using the position of the element in the
          array. The array can have one or more dimensions.
        </p>
      </div>
        ...
        <div className="row justify-content-around  mt-auto mt-sm-5 p-2">
          <div className="col-sm-auto align-self-center">
            ...
            <ul className="size">
              <li>
                <a
                  href="https://en.wikipedia.org/wiki/Array_(data_structure)"
                  target="_blank"
                  rel="noreferrer"
                >
                  Wiki - Array (data structure)
                </a>
              </li>
              -
              <li>
              ...
              <li>
                <a
                  href="https://www.geeksforgeeks.org/multidimensional-arrays-c-cpp/"
                  target="_blank"
                  rel="noreferrer"
                >
          ...
          <div className="col-auto  text-center vid">
            <iframe
              ...
              width="auto"
              height="auto"
              src="https://www.youtube.com/embed/NptnmWvkbTw"
