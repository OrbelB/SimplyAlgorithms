...
const formReducer = (state, action) => {
  switch (action.type) {
    ...
    case 'maxInputToken': {
      ...
      if (parsedNumber < 50 || parsedNumber > 2048)
        return { ...state, maxInputToken: 50 };
      return { ...state, maxInputToken: parsedNumber };
    }
    case 'maxOutputToken':
            ...
            <Grid container spacing={3} direction="row">
              ...
              <Grid item xs={12} md={12}>
                <TextField
                  ...
                  onChange={(e) =>
                    formDispatch({
                      type: 'maxInputToken',
                      paylaod: e.target.valueAsNumber,
                    })
                  }
                  variant="standard"
              ...
              <Grid item xs={12} md={12}>
                <TextField
                  ...
                  helperText="This is the max amount of tokens that can be generated by Chatty"
                  name="outPutToken"
                />
              </Grid>
              <Grid item xs={12} md={12}>
