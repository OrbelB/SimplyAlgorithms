...
import { selected_topic1 } from "../CommentsDB";
...
<div className="text-center m-2">
    <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#backdrop1">
        Show More
    </button>
</div>

{/* <!-- Modal --> */}
<div className="modal fade" id="backdrop1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content bg">
      <div class="modal-header">
        <h2 class="modal-title" id="staticBackdropLabel">Comments</h2>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div>
            {selected_topic1.map(({topic}) => {
                return(
                <div>
