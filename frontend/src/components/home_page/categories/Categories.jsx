    ...
    return (
        <div className="wrap-collabsible">
            ...
            <div className="input-space">
                ...
                <label htmlFor="collapsible" className="lbl-toggle cat1">Sorting</label>
            ...
            <div className="input-space">
                ...
                <label htmlFor="collapsible2" className="lbl-toggle cat2">Trees</label>
                <div className="collapsible-content">
                    <div className="content-inner">
            ...
            <div className="input-space">
                ...
                <label htmlFor="collapsible3" className="lbl-toggle cat3">Graphs</label>
                <div className="collapsible-content">
                    <div className="content-inner">
            ...
            <div className="input-space">
                ...
                <label htmlFor="collapsible4" className="lbl-toggle cat4">Data Structures</label>
                <div className="collapsible-content">
                    <div className="content-inner">
