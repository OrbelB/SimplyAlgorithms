    ...
    <div className="forum-section">
      ...
      <div className="forum-body">
        ...
        <p className="body">
          ...
          browse the numerous posts that other users have written on it. You
          might wish to write a post and look into the topic at the same time.
          There are numerous topics to discuss, so begin a discussion now!
        </p>
      </div>
      <form>
