                    ...
                    <div class="card">
                        <div class="card-body">
                            <nav class="nav flex-column nav-pills nav-gap-y-1">
                                <NavLink to="/settings/profile"  data-toggle="tab" className={"nav-item nav-link has-icon nav-link-faded active"}>
                    ...
                    <div class="card">
                        <div class="card-header border-bottom mb-3 d-flex d-md-none">
                            <ul class="nav nav-tabs card-header-tabs nav-gap-x-1" role="tablist">
                                <li class="nav-item">
                                <NavLink to="/settings/profile"  data-toggle="tab" className={"nav-link has-icon active"}>
