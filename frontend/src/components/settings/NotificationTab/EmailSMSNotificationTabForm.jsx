...
export default function EmailSMSNotificationTabForm(){
    return (
        <div>
            {currentUserInfo.map(({email,number}) => {
              return (
                <div>
                    <form>
                        ...
                        <div class="mb-1">
                            ...
                            <input className="form-control bg-secondary bg-gradient text-white" id="inputNotificationSMS" type="email" value={number} readonly/>
                        </div>
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="gridCheck"/>
