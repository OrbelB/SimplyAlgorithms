                ...
                <div className={"row justify-content-around  mt-auto mt-sm-5   p-2"}>
                    ...
                    <h3 className={"m-3 mb-4"}>FURTHER REFERENCES</h3>
                        <ul className="size">
                            ...
                            -
                            <li><a href="https://en.wikipedia.org/wiki/Breadth-first_search" target="_blank" rel="noreferrer">wikipedia - Breadth-first search</a></li>
                        </ul>
                    </div>
                    <div className={"col-auto  text-center vid"}>
                        <iframe className="rounded-4 " width="auto" height="auto"
                                src="https://www.youtube.com/embed/pcKY4hjDrxk" title="YouTube video player"
