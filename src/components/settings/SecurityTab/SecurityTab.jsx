...
import SecurityTabForm from "./SecurityTabForm";
                    ...
                    <div class="card">
                        <div class="card-body">
                            <nav class="nav flex-column nav-pills nav-gap-y-1">
                                ...
                                <NavLink to="/settings/security"  data-toggle="tab" className={"nav-item nav-link has-icon nav-link-faded active"}>
                                ...
                                <NavLink to="/settings/notifications"  data-toggle="tab" className={"nav-item nav-link has-icon nav-link-faded"}>
                    ...
                    <div class="card">
                        <div class="card-header border-bottom mb-3 d-flex d-md-none">
                            <ul class="nav nav-tabs card-header-tabs nav-gap-x-1" role="tablist">
                                ...
                                <li class="nav-item">
                                <NavLink to="/settings/security"  data-toggle="tab" className={"nav-link has-icon active"}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shield"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                                </NavLink>
                                </li>
                                <li class="nav-item">
                                <NavLink to="/settings/notifications"  data-toggle="tab" className={"nav-link has-icon"}>
